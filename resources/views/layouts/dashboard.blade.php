...
<div class="container-xxl" style="background-color : rgba(0,0,0, 0.6) !Important; width: 98% !Important;  padding-bottom : 10px !Important; height: 25vh;">

<div class="row" style="color: #fff; padding-bottom: 15px;">
<div class="col-md-8">  <h1>Automart | AAKENYA</h1>
...
<!-- Navbar -->
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: rgba(254,217,37, 0.8); border-radius:10px;">
  <!-- Container wrapper -->
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link" href="#0">My Cars</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#1">Subscriptions</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#2">Sells</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#3">Add Car</a>
        </li>
