...
<select class="" id="make" name="make" aria-hidden="true" style="width: 100%; background-color: rgba(0,0,0, 0.6); color: #fff; border-radius:8px;padding-top:10px;padding-bottom:10px;" required>
...
<!-- Single item -->
<div class="carousel-item">
<img src="{{ url('public/images/' . json_decode($vehicle->images, true)[0]) }}" class="d-block w-100" alt="Cliff Above a Stormy Sea"
style="height:370px;"/>
<div class="carousel-caption d-none d-md-block">
<h5>Car Images </h5>
<p><b>make / model  <i class="fas fa-phone fa-1x"></i>&nbsp;phone
