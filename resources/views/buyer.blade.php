...
<div class="col-md-12">
<a href="{{ route('logout')}}"><button type="submit" class="btn btn-danger btn-block">Logout</button></a>
</div>
</br>
  </div>
  <div class="col-md-10">
  ...
  <p class="card-text">When you add a product to your wish list or online shopping cart, 
    it&apos;s clear you&apos;re interested. If you act like you&apos;re going to buy something and 
    then back out just before you make your purchase, there&apos;s a chance you&apos;ll get an 
    email with a promo code or a &apos;price lowered&apos; notification to encourage you to go back and follow through.</p>
    <h5 class="card-title">Get Social</h5>
    <p class="card-text">Once you get car dealer contacts call and follow their socials. Many Car Dealers will announce special flash sales for their social media followers,
       and some even offer free shipping codes. If you really love a certain shop or brand, 
       follow them on social media and take advantage of being in the loop. But tread carefully here. 
       Sometimes, following your favorites on social media can tempt you with major impulse buys, so look out!</p>
  </div>
</div>
